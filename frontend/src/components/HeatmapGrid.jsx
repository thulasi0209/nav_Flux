...
const HeatmapGrid = ({ heatmap }) => {
  // congestion_score is a 0-1 float (occupancy / lane capacity)
  const getCongestionColor = (score) => {
    if (score < 0.34) return 'bg-emerald-500/20 text-emerald-400 border-emerald-400/20';
    if (score < 0.7) return 'bg-amber-500/20 text-amber-400 border-amber-400/20';
